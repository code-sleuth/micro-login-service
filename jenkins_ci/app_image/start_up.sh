...
start_app() {
  local app_root="/usr/src/app"
    ...
    echo 'VOF_INFRASTRUCTURE_REPO': ${VOF_INFRASTRUCTURE_REPO}
    echo 'BUGSNAG_KEY': ${BUGSNAG_KEY}
    echo 'USER_MICROSERVICE_API_URL': ${USER_MICROSERVICE_API_URL}
    echo 'USER_MICROSERVICE_API_TOKEN': ${USER_MICROSERVICE_API_TOKEN}
    echo 'STAGING_RESERVED_IP': ${STAGING_RESERVED_IP}
    echo 'SANDBOX_RESERVED_IP': ${SANDBOX_RESERVED_IP}
    echo 'PRODUCTION_RESERVED_IP': ${PRODUCTION_RESERVED_IP}
    echo 'PRODUCTION_BUGSNAG_KEY': ${PRODUCTION_BUGSNAG_KEY}
